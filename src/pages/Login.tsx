...
export default function Login() {
    ...
    useEffect(() => {
        ...
        const detectInAppBrowser = () => {
            ...
            const label = isInstagram ? "Instagram" : isFacebookFamily ? "Facebook/Messenger" : isTikTok ? "TikTok" : isTwitter ? "Twitter" : "embedded";
        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
            <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-card">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">Connect your Instagram account to continue.</p>
                </div>
                ...
                {inAppBrowser.isInApp && (
                    <div className="mb-4 rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-700 dark:text-amber-300">
                        <p>Instagram login cannot complete inside the {inAppBrowser.label} in-app browser. Tap the menu and choose “Open in Safari/Chrome”, then try again.</p>
                ...
                {inAppBrowser.isInApp && <p className="mt-3 text-center text-xs text-muted-foreground">Open this page in your mobile browser to enable Instagram authentication.</p>}
